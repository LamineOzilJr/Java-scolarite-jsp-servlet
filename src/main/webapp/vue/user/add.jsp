...
<%@ page import="com.groupeisi.scolarite.dto.RoleDto" %><%--
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="/Role">
                        <i class="bi bi-circle"></i><span>Ajout d'un Role</span>
                    </a>
                </li>
                <li>
                    <a href="/List/Role">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="/User">
                        <i class="bi bi-circle"></i><span>Ajout d'un Utilisateur</span>
                    </a>
                </li>
                <li>
                    <a href="/List/User">
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-6 m-auto ">
                ...
                <form action="/User" method="post" class="form p-5 form-control bg-info-light">
                    <label>Mail de l'utilisateur</label>
                    <input type="email" name="email" class="form-control form mt-2"> <br>
                    <label>Mot de passe de l'utilisateur</label>
                    <input type="password" name="pass" class="form-control form mt-2"> <br>
                    <label>Role User</label>
                    <select name="roles" id="" class="form-control form mt-2">
                        <%
                    ...
                    <input type="submit" value="Ajouter l'utilisateur" class="btn btn-success mt-2"> <br>
...
<%--    </select>--%>
<%--    <input type="submit" value="Ajouter l'utilisateur"> <br>--%>
